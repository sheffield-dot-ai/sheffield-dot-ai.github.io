...
export default function TodoList(props: Props) {
    ...
    return <div className={[props.className ?? '', classes.container].join(' ')}>
        <h4 className={classes.title}>{props.title}</h4>
        <svg viewBox="0 0 400 20" xmlns="http://www.w3.org/2000/svg" className={classes.underline} style={{width: `${(props.title.length / 2) - 1}em`}}>
